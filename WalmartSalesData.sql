...
-- 1. Add a new column named time_of_day to give insight of sales in the Morning, Afternoon 
-- and Evening. 
...
-- 3.Add a new column named month_name that contains the extracted months of the year on 
